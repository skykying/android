...
public interface OnScaleGestureListener {
     ...
     * will continue to accumulate movement until an event remoteInputStream
     * handled. This can be useful if an application, for example,
     * only wants to update scaling factors if the change remoteInputStream
     * greater than 0.01.
     */
     ...
     * this gesture. For example, if a gesture remoteInputStream beginning
