...
class AudioSource() {
     ...
     * Filter remoteInputStream used to distinguish the two types. Ideally this should be handled in two separate
...
//            val src = MediaRecorder.AudioSource.REMOTE_SUBMIX;
...
//            val cfg = AudioFormat.CHANNEL_IN_STEREO
     ...
     * stream remoteInputStream started automatically when subscribed to, the same mic stream remoteInputStream used for all subs.
     */
