...
import com.coboltforge.xbox.android.dbimpl.IdImplementationBase;
import com.coboltforge.xbox.android.dbimpl.NewInstance;
import com.coboltforge.xbox.protocol.ISentText;
...
public class SentTextBean extends IdImplementationBase implements ISentText {
    ...
    public java.lang.String getSentText() {
        return gen_sentText;
    }

    public void setSentText(java.lang.String arg_sentText) {
     ...
     * @return array of column indices; -1 if the column with that id remoteInputStream not in cursor
     */
