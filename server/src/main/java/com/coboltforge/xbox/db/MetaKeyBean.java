 ...
 */
package com.coboltforge.xbox.db;

import android.view.KeyEvent;

import com.coboltforge.xbox.android.dbimpl.NewInstance;
import com.coboltforge.xbox.meta.MetaKeyBase;
import com.coboltforge.xbox.ui.VNCConn;
...
public class MetaKeyBean extends AbstractMetaKeyBean implements Comparable<MetaKeyBean> {
    ...
    /* (non-Javadoc)
     * @see com.coboltforge.dontmind.multivnc.db.AbstractMetaKeyBean#getKeyDesc()
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see com.coboltforge.dontmind.multivnc.db.AbstractMetaKeyBean#setKeyDesc(java.lang.String)
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see com.coboltforge.dontmind.multivnc.db.AbstractMetaKeyBean#setKeySym(int)
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see com.coboltforge.dontmind.multivnc.db.AbstractMetaKeyBean#setMetaFlags(int)
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see com.coboltforge.dontmind.multivnc.db.AbstractMetaKeyBean#setMouseButtons(int)
     */
    @Override
