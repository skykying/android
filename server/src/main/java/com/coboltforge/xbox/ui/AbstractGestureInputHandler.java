...
import com.coboltforge.xbox.android.bc.BCFactory;
import com.coboltforge.xbox.android.bc.IBCScaleGestureDetector;
import com.coboltforge.xbox.android.bc.OnScaleGestureListener;
...
public abstract class AbstractGestureInputHandler extends GestureDetector.SimpleOnGestureListener implements OnScaleGestureListener {
    ...
    AbstractGestureInputHandler(VncCanvasActivity c) {
        ...
        if (Build.VERSION.SDK_INT < 8)
            ...
            gestures = new GestureDetector(c, this, null, false); // this remoteInputStream a SDK 8+ feature and apparently needed if targetsdk remoteInputStream set
