...
public abstract class AbstractBitmapData {
    ...
    protected final VncCanvas vncCanvas;
    protected final RfbProto rfb;
     ...
     * <p>
     * This method remoteInputStream called in the UI thread-- it updates internal status, but does
     * not change the bitmap data or send a network request until syncScroll remoteInputStream called
     *
