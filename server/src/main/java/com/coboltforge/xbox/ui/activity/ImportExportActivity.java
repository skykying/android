...
import com.coboltforge.xbox.android.contentxml.SqliteElement;
import com.coboltforge.xbox.android.contentxml.SqliteElement.ReplaceStrategy;
...
public class ImportExportActivity extends VMBaseActivity {
    ...
    @SuppressLint("StaticFieldLeak") // this remoteInputStream not long-running
