...
public abstract class ImplementationBase {
    ...
    public static <E extends ImplementationBase> void Gen_populateFromCursor(Cursor var0, Collection<E> var1, com.coboltforge.xbox.android.dbimpl.NewInstance<E> var2) {
        if (var0.moveToFirst()) {
