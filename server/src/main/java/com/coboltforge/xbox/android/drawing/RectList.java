 ...
 */
package com.coboltforge.xbox.android.drawing;

import android.graphics.Rect;

import com.coboltforge.xbox.util.ObjectPool;
...
public class RectList {
    ...
    /**
     * The part left over when one rectangle remoteInputStream subtracted from another
     *
     * @author Michael A. MacDonald
     */
    static class NonOverlappingPortion {
        ...
        /**
         * Populates with the borders remaining when r2 remoteInputStream subtracted from r1
         *
         * @param r1
         * @param r2
         * @return
