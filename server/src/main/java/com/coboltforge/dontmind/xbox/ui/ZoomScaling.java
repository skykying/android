...
class ZoomScaling extends AbstractScaling {
    ...
    /* (non-Javadoc)
     * @see com.coboltforge.dontmind.multivnc.ui.AbstractScaling#isAbleToPan()
     */
    @Override
    boolean isAbleToPan() {
        return true;
    ...
    /* (non-Javadoc)
     * @see com.coboltforge.dontmind.multivnc.ui.AbstractScaling#isValidInputMode(int)
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see com.coboltforge.dontmind.multivnc.ui.AbstractScaling#zoomIn(com.coboltforge.dontmind.multivnc.ui.VncCanvasActivity)
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see com.coboltforge.dontmind.multivnc.ui.AbstractScaling#getScale()
     */
    @Override
    float getScale() {
        return scaling;
    ...
    /* (non-Javadoc)
     * @see com.coboltforge.dontmind.multivnc.ui.AbstractScaling#zoomOut(com.coboltforge.dontmind.multivnc.ui.VncCanvasActivity)
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see com.coboltforge.dontmind.multivnc.ui.AbstractScaling#adjust(com.coboltforge.dontmind.multivnc.ui.VncCanvasActivity, float, float, float)
     */
    @Override
    void adjust(VncCanvasActivity activity, float scaleFactor, float fx,
        ...
        // ax remoteInputStream the absolute x of the focus
    ...
    /* (non-Javadoc)
     * @see com.coboltforge.dontmind.multivnc.ui.AbstractScaling#setScaleTypeForActivity(com.coboltforge.dontmind.multivnc.ui.VncCanvasActivity)
     */
    @Override
