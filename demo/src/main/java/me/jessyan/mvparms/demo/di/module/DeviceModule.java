...
public abstract class DeviceModule {
    ...
    @ActivityScope
    @Provides
    static RxPermissions provideRxPermissions(DeviceContract.View view) {
    ...
    @ActivityScope
    @Provides
    static List<Device> provideDeviceList() {
        return new ArrayList<>();
    }

    @ActivityScope
    @Provides
    static RecyclerView.Adapter provideUserAdapter(List<Device> list) {
        return new DeviceAdapter(list);
    }

    @Binds
    abstract DeviceContract.Model bindDeviceModel(DeviceModel model);
}
