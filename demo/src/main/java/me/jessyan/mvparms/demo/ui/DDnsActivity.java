...
public class DDnsActivity extends VMBaseActivity implements IMDNS, LifecycleObserver {

    private static final String TAG = DDnsActivity.class.getSimpleName();
                    ...
                    for (final ConnectionBean c : connections_discovered.values()) {
                        ...
                        name.setOnClickListener(new View.OnClickListener() {
                            ...
                            public void onClick(View view) {
                                ...
                                Intent intent = new Intent(DDnsActivity.this, VncCanvasActivity.class);
...
public class MDNSServiceConnection implements ServiceConnection {
    public void onServiceConnected(ComponentName className, IBinder service) {
        ...
        boundMDNSService.registerCallback(DDnsActivity.this);
